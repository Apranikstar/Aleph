...
from config_aleph import variables_pfcand, variables_jet, flavors
...
print("-> opened input file: {}".format(input_file))
print("-> number of events in input file: {}".format(numberOfEntries))
...
print("-> preparing to store jet branches: {}".format(branches_jet))
...
for entry in range(n_start, n_final):
    ...
    # print("-> processing event {}, number of jets: {}".format(entry, njets))
