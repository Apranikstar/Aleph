...
# PHOTONS — Pads
        ...
        df = df.Define("pfcand_dEdx_pads_ph",
               "AlephSelection::build_constituents_dEdx_filtered()("
               "jetConstitutentsTypes,"
               "RecoParticles, _RecoParticles_tracks.index,"
               "dEdxPads, _dEdxPads_track.index,"
...
## PHOTONS — Wires
        ...
        df = df.Define("pfcand_dEdx_wires_ph",
               "AlephSelection::build_constituents_dEdx_filtered()("
               "jetConstitutentsTypes,"
               "RecoParticles, _RecoParticles_tracks.index,"
               "dEdxWires, _dEdxWires_track.index,"
...
# NEUTRAL HADRONS — Pads

        df = df.Define("pfcand_dEdx_pads_nh",
               "AlephSelection::build_constituents_dEdx_filtered()("
               "jetConstitutentsTypes,"
               "RecoParticles, _RecoParticles_tracks.index,"
               "dEdxPads, _dEdxPads_track.index,"
...
# NEUTRAL HADRONS — Wires

        df = df.Define("pfcand_dEdx_wires_nh",
               "AlephSelection::build_constituents_dEdx_filtered()("
               "jetConstitutentsTypes,"
               "RecoParticles, _RecoParticles_tracks.index,"
               "dEdxWires, _dEdxWires_track.index,"
