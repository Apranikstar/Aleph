...
# ELECTRONS — Pads
        df = df.Define("pfcand_dEdx_pads_el",
               "AlephSelection::build_constituents_dEdx_filtered()("
               "jetConstitutentsTypes,"
               "RecoParticles, _RecoParticles_tracks.index,"
               "dEdxPads, _dEdxPads_track.index,"
               "_jetc, 1)")
        df = df.Define("pfcand_dEdx_el_type",  "AlephSelection::get_dEdx_type(pfcand_dEdx_pads_el)")
        df = df.Define("pfcand_dEdx_el_value", "AlephSelection::get_dEdx_value(pfcand_dEdx_pads_el)")
        df = df.Define("pfcand_dEdx_el_error", "AlephSelection::get_dEdx_error(pfcand_dEdx_pads_el)")

# ELECTRONS — Wires
        df = df.Define("pfcand_dEdx_wires_el",
               "AlephSelection::build_constituents_dEdx_filtered()("
               "jetConstitutentsTypes,"
               "RecoParticles, _RecoParticles_tracks.index,"
               "dEdxWires, _dEdxWires_track.index,"
               "_jetc, 1)")
        df = df.Define("pfcand_dEdx_el_wire_type",  "AlephSelection::get_dEdx_type(pfcand_dEdx_wires_el)")
        df = df.Define("pfcand_dEdx_el_wire_value", "AlephSelection::get_dEdx_value(pfcand_dEdx_wires_el)")
        df = df.Define("pfcand_dEdx_el_wire_error", "AlephSelection::get_dEdx_error(pfcand_dEdx_wires_el)")


# MUONS — Pads
        df = df.Define("pfcand_dEdx_pads_mu",
               "AlephSelection::build_constituents_dEdx_filtered()("
               "jetConstitutentsTypes,"
               "RecoParticles, _RecoParticles_tracks.index,"
               "dEdxPads, _dEdxPads_track.index,"
               "_jetc, 2)")
        df = df.Define("pfcand_dEdx_mu_type",  "AlephSelection::get_dEdx_type(pfcand_dEdx_pads_mu)")
        df = df.Define("pfcand_dEdx_mu_value", "AlephSelection::get_dEdx_value(pfcand_dEdx_pads_mu)")
        df = df.Define("pfcand_dEdx_mu_error", "AlephSelection::get_dEdx_error(pfcand_dEdx_pads_mu)")

# MUONS — Wires
        df = df.Define("pfcand_dEdx_wires_mu",
               "AlephSelection::build_constituents_dEdx_filtered()("
               "jetConstitutentsTypes,"
               "RecoParticles, _RecoParticles_tracks.index,"
               "dEdxWires, _dEdxWires_track.index,"
               "_jetc, 2)")
        df = df.Define("pfcand_dEdx_mu_wire_type",  "AlephSelection::get_dEdx_type(pfcand_dEdx_wires_mu)")
        df = df.Define("pfcand_dEdx_mu_wire_value", "AlephSelection::get_dEdx_value(pfcand_dEdx_wires_mu)")
        df = df.Define("pfcand_dEdx_mu_wire_error", "AlephSelection::get_dEdx_error(pfcand_dEdx_wires_mu)")


# CHARGED HADRONS — Pads (π/K/p)
        df = df.Define("pfcand_dEdx_pads_ch",
               "AlephSelection::build_constituents_dEdx_filtered()("
               "jetConstitutentsTypes,"
               "RecoParticles, _RecoParticles_tracks.index,"
               "dEdxPads, _dEdxPads_track.index,"
               "_jetc, 0)")
        df = df.Define("pfcand_dEdx_ch_type",  "AlephSelection::get_dEdx_type(pfcand_dEdx_pads_ch)")
        df = df.Define("pfcand_dEdx_ch_value", "AlephSelection::get_dEdx_value(pfcand_dEdx_pads_ch)")
        df = df.Define("pfcand_dEdx_ch_error", "AlephSelection::get_dEdx_error(pfcand_dEdx_pads_ch)")

# CHARGED HADRONS — Wires
        df = df.Define("pfcand_dEdx_wires_ch",
               "AlephSelection::build_constituents_dEdx_filtered()("
               "jetConstitutentsTypes,"
               "RecoParticles, _RecoParticles_tracks.index,"
               "dEdxWires, _dEdxWires_track.index,"
               "_jetc, 0)")
        df = df.Define("pfcand_dEdx_ch_wire_type",  "AlephSelection::get_dEdx_type(pfcand_dEdx_wires_ch)")
        df = df.Define("pfcand_dEdx_ch_wire_value", "AlephSelection::get_dEdx_value(pfcand_dEdx_wires_ch)")
        df = df.Define("pfcand_dEdx_ch_wire_error", "AlephSelection::get_dEdx_error(pfcand_dEdx_wires_ch)")
